...
#include "flash_hip.h"
#include "flash_fwd_kernel_hip.h"
                ...
                BOOL_SWITCH(return_softmax, ReturnSoftmaxConst, [&] {
                    ALIBI_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                        SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                           ...
                           hipLaunchKernelGGL(( kernel), dim3(grid), dim3(Kernel_traits::kNThreads), smem_size, stream, params);
    ...
    if (params.num_splits > 1) {
        ...
        EVENK_SWITCH(is_even_K, IsEvenKConst, [&] {
            if (params.num_splits <= 2) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 1, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } 
            else if (params.num_splits <= 4) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 2, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } else if (params.num_splits <= 8) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 3, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } else if (params.num_splits <= 16) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 4, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } else if (params.num_splits <= 32) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 5, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } else if (params.num_splits <= 64) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 6, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            } else if (params.num_splits <= 128) {
               hipLaunchKernelGGL(( flash_fwd_splitkv_combine_kernel<Kernel_traits, kBlockM, 7, IsEvenKConst>), dim3(grid_combine), dim3(Kernel_traits::kNThreads), 0, stream, params);
            }
            // C10_HIP_KERNEL_LAUNCH_CHECK();
        });
    }
