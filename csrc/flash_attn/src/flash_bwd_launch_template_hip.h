...
#include "flash_hip.h"
#include "flash_bwd_preprocess_kernel_hip.h"
#include "flash_bwd_kernel_hip.h"
...
void run_flash_bwd_seqk_parallel(Flash_bwd_params &params, hipStream_t stream) {
    ...
    if (!params.deterministic) {
       hipLaunchKernelGGL(( flash_bwd_dot_do_o_kernel<true, Kernel_traits>), dim3(grid_m), dim3(Kernel_traits::kNThreads), 0, stream, params);
    } else {
       hipLaunchKernelGGL(( flash_bwd_dot_do_o_kernel<false, Kernel_traits>), dim3(grid_m), dim3(Kernel_traits::kNThreads), 0, stream, params);
    }
            ...
            LOCAL_SWITCH((params.window_size_left >= 0 || params.window_size_right >= 0) && !params.is_causal, Is_local, [&] {
                ALIBI_SWITCH(params.alibi_slopes_ptr != nullptr, Has_alibi, [&] {
                    SOFTCAP_SWITCH(params.softcap > 0.0, Is_softcap, [&] {
                       ...
                       hipLaunchKernelGGL(( kernel), dim3(grid_n), dim3(Kernel_traits::kNThreads), smem_size_dq_dk_dv, stream, params);
                        C10_HIP_KERNEL_LAUNCH_CHECK();
                    });
                });
            });
    ...
    // }
   hipLaunchKernelGGL(( kernel_dq), dim3(grid_m), dim3(Kernel_traits::kNThreads), Kernel_traits::kSmemdQSize, stream, params, !params.deterministic ? 1 : gridDimx);
    C10_HIP_KERNEL_LAUNCH_CHECK();
}

template<typename Kernel_traits, bool Is_dropout, bool Is_causal>
void run_flash_bwd(Flash_bwd_params &params, hipStream_t stream) {
...
void run_mha_bwd_hdim32(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim64(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim96(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim128(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim160(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim192(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim224(Flash_bwd_params &params, hipStream_t stream) {
...
template<typename T, bool Is_causal>
void run_mha_bwd_hdim256(Flash_bwd_params &params, hipStream_t stream) {
