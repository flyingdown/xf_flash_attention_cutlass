...
void print_params_python(Flash_fwd_params &params)
{
    std::cout << "python_api params" << std::endl;
...
//     const int num_splits, hipDeviceProp_t *dprops, struct c10::TensorOptions opts) {
...
mha_fwd(at::Tensor &q,         // batch_size x seqlen_q x num_heads x head_size
    ...
    // printf("mha_fwd params.num_splits = %d\n", params.num_splits);
    ...
    if (seqlen_k > 0) {
        ...
        fmha_fwd(q_padded.data_ptr(), k_padded.data_ptr(), v_padded.data_ptr(), 
            out.data_ptr(), alibi_slopes_ptr, seqlen_q, seqlen_k, batch_size, num_heads, num_heads_k, 
            head_size, p_dropout, stream, dprops, softmax_scale, return_softmax ? p.data_ptr() : nullptr, softmax_lse.data_ptr(),
            window_size_left, window_size_right, softcap, return_softmax, q_dtype == torch::kFloat16);
...
mha_fwd_kvcache(at::Tensor &q,                 // batch_size x seqlen_q x num_heads x head_size
    ...
    //std::cout << "params.is_bf16 set : " << (q_padded.dtype() == torch::kFloat16)  << std::endl;
...
///////////////////////////////////////////////////////////////////////////////////////////////
    ...
    fmha_page_kvcache_fwd(
        ...
        /*const int32_t max_cache_seq_k*/seqlen_k,
        seqlen_q,
        seqlen_k,
        batch_size,
        num_heads,
        ...
        /*bool is_fp16*/q_padded.dtype() == torch::kFloat16
